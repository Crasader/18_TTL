...
public:
	std::string& getAppID() { return m_kWxAppId; }
public:
	void logonWeiXin();
	void restWeiXin();
	WX_Action_State getWXActionState();
	void setWXActionState(WX_Action_State state);
