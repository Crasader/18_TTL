...
public:
	//初始化房间
	virtual bool ConnectServer(CGameServerItem * pGameServerItem,word wAVServerPort = 0,dword dwAVServerAddr = 0);
	//中断连接
...
protected:
	...
	//获得桌子椅子数量
	virtual int GetCurServerChairsCount();
	//获得游戏服务
	//////////////////////////////////////////////////////////////////////////
	// IUserManagerSink
	//////////////////////////////////////////////////////////////////////////
...
public:
	...
	bool OnSocketSubPrivateInQureTableRet(void* data, int dataSize);

	//发送私人场
	virtual bool sendSubGRPrivateInfo();
	//请求私人场桌子数据
	virtual bool sendPrivateTablesInfo();
	//////////////////////////////////////////////////////////////////////////

	//////////////////////////////////////////////////////////////////////////
	////抽奖测试信息
	//bool OnSocketMainChouJiang(int sub, void* data, int dataSize);
	//bool OnSocketSubChouJiangInfo(void* data, int dataSize);
	//bool OnSocketSubChouJiangFail(void* data, int dataSize);
	//bool OnSocketSubChouJiangSuccess(void* data, int dataSize);

	//////////////////////////////////////////////////////////////////////////

    //////////////////////////////////////////////////////////////////////////
    //私人场消息
    bool OnSocketSystemMessage(int sub, void* data, int dataSize);

    //系统通知消息
    bool OnSocketSystemNotify(int sub, void* data, int dataSize);
...
public:
	...
	//房间关闭
	virtual void OnGFRoomClose(int iExitCode);
