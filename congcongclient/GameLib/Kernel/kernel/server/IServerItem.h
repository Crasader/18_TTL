...
public:
	//连接服务器
	virtual bool ConnectServer(CGameServerItem * pGameServerItem,word wAVServerPort = 0,dword dwAVServerAddr = 0)=0;
	//连接断开
...
public:
	...
	//动作处理
public:
    virtual bool SendLogonPacket()=0;
	//执行快速加入
...
public:
	...
	virtual int GetCurServerChairsCount()=0;
	//获得游戏服务
	//////////////////////////////////////////////////////////////////////////
	// 框架消息
public:
