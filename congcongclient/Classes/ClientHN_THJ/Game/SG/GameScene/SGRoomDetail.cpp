...
void SGRoomDetail::show()
{
 ...
 //   }
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_Score_0))){
	//	scoreText.append("1");
	//	if (info.bGameTypeIdex != TTLSG::SGGameType_AllCompare) {
	//		scoreText.append("/2");
	//	}
	//} else if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_Score_1))){
	//	scoreText.append("2");
	//	if (info.bGameTypeIdex != TTLSG::SGGameType_AllCompare) {
	//		scoreText.append("/4");
	//	}
	//} else if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_Score_2))){
	//	scoreText.append("4");
	//	if (info.bGameTypeIdex != TTLSG::SGGameType_AllCompare) {
	//		scoreText.append("/8");
	//	}
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_Ratio_0))) {
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_Pay_0))){
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_ExpertSetting_1))) {
	//	roomRuleText.append(utility::a_u8("闲家推注 "));
	//}

	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_ExpertSetting_2))) {
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_SpecialRule_1))) {
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_SpecialRule_2))) {
	...
	//if (FvMask::HasAny(info.dwGameRuleIdex, _MASK_(TTLSG::SGGameRule_SpecialRule_3))) {
