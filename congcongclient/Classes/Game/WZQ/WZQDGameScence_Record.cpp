...
//void WZQDGameScence::initRecord()
//{
//	WidgetScenceXMLparse kScence("Script/HNGameRecordChild.xml",this);
//
//	WidgetManager::addButtonCB("Button_GameRecordPlay",this,button_selector(WZQDGameScence::Button_GameRecordPlay));
//	WidgetManager::addButtonCB("Button_GameRecordPase",this,button_selector(WZQDGameScence::Button_GameRecordPase));
//	WidgetManager::addButtonCB("Button_GameRecordLeft",this,button_selector(WZQDGameScence::Button_GameRecordLeft));
//	WidgetManager::addButtonCB("Button_GameRecordRight",this,button_selector(WZQDGameScence::Button_GameRecordRight));
//	WidgetManager::addButtonCB("Button_GameRecordExit",this,button_selector(WZQDGameScence::Button_GameRecordExit));
//}
//void WZQDGameScence::defaultRecordState()
//{
...
//	}
//}
//void WZQDGameScence::Button_GameRecordPlay(cocos2d::Ref*,WidgetUserInfo*)
//{
...
//	m_RecordTimeID = TimeManager::Instance().addCerterTimeCB(TIME_CALLBACK(WZQDGameScence::NextRecordAction,this),m_RecordTime)->iIdex;
//}
//void WZQDGameScence::Button_GameRecordPase(cocos2d::Ref*,WidgetUserInfo*)
//{
//	WidgetFun::setVisible(this,"Button_GameRecordPlay",true);
//	WidgetFun::setVisible(this,"Button_GameRecordPase",false);
//	TimeManager::Instance().removeByID(m_RecordTimeID);
//}
//void WZQDGameScence::Button_GameRecordLeft(cocos2d::Ref*,WidgetUserInfo*)
//{
//	m_RecordTime += 0.5f;
//}
//void WZQDGameScence::Button_GameRecordRight(cocos2d::Ref*,WidgetUserInfo*)
//{
//	m_RecordTime -= 0.5f;
...
//	}
//}
//void WZQDGameScence::Button_GameRecordExit(cocos2d::Ref*,WidgetUserInfo*)
//{
//	TimeManager::Instance().removeByID(m_RecordTimeID);
//	exitRoom();
//}
//bool WZQDGameScence::StartRecord(datastream kDataStream)
//{
...
//	return true;
//}
//void WZQDGameScence::NextRecordAction()
//{
...
//}
//void WZQDGameScence::onGPAccountInfoHttpIP(dword dwUserID, std::string strIP,std::string strHttp)
//{
