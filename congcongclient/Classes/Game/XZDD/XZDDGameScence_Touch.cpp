...
// 			}
			...
			if(m_Touch_CS &&m_pTouchCardNode_old == m_pTouchCardNode )
			{
				if (m_bselectGangState)
				{
					XZDD::CMD_C_OperateCard OperateCard;
			...
			m_pTouchCardNode_old = m_pTouchCardNode;
		}
	}
	return false;
}
...
void XZDDGameScence::SendOutCard(cocos2d::Node* pCard)//出牌命令
{
