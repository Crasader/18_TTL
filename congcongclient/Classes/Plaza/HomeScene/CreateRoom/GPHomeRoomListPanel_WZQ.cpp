...
void GPHomeRoomListPanel_WZQ::initListView(){
	widget::ListViewEx* pListView = WidgetFun::getListViewWidget(this,"GameListView_WZQ");
	...
	pListView->addEventListener((widget::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeRoomListPanel_WZQ::onSelectedItemEvent,this));
...
void GPHomeRoomListPanel_WZQ::RefreshListView(void* data, size_t dataSize){
    ...
    widget::ListViewEx* pList = WidgetFun::getListViewWidget(this,"GameListView_WZQ");
