...
void GPHomeRoomListPanel_TLJ::initListView(){
	widget::ListViewEx* pListView = WidgetFun::getListViewWidget(this,"GameListView_TLJ");
	...
	pListView->addEventListener((widget::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeRoomListPanel_TLJ::onSelectedItemEvent,this));
...
void GPHomeRoomListPanel_TLJ::RefreshListView(void* data, size_t dataSize){
    ...
    widget::ListViewEx* pList = WidgetFun::getListViewWidget(this,"GameListView_TLJ");
