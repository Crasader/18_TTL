...
void GPHomeMallPanel::Button_Buy(cocos2d::Ref* pRef, WidgetUserInfo* pInfo)
{
    ...
    std::string gameGold = script::getStr(utility::toString("GameGold"));
    std::string gameAddGold = script::getStr(utility::toString("GameAddGold"));
...
{
    widget::ListViewEx* pListView = WidgetFun::getListViewWidget(this,"MallContentListSkin");
	...
	pListView->addEventListener((widget::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeMallPanel::onSelectedItemEvent,this));
}
