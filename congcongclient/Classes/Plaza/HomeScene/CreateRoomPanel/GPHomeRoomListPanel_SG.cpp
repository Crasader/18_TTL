...
void GPHomeRoomListPanel_SG::initListView(){
	cocos2d::ListViewEx* pListView = WidgetFun::getListViewWidget(this,"GameListView_SG");
	...
	pListView->addEventListener((cocos2d::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeRoomListPanel_SG::onSelectedItemEvent,this));
...
void GPHomeRoomListPanel_SG::RefreshListView(void* data, size_t dataSize){
    ...
    cocos2d::ListViewEx* pList = WidgetFun::getListViewWidget(this,"GameListView_SG");
