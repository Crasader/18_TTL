...
void GPHomeRoomListPanel_NN::initListView(){
	cocos2d::ListViewEx* pListView = WidgetFun::getListViewWidget(this,"GameListView_NN");
	...
	pListView->addEventListener((cocos2d::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeRoomListPanel_NN::onSelectedItemEvent,this));
...
void GPHomeRoomListPanel_NN::RefreshListView(void* data, size_t dataSize){
    ...
    cocos2d::ListViewEx* pList = WidgetFun::getListViewWidget(this,"GameListView_NN");
