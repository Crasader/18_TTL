...
void GPHomeRoomListPanel_SRLF::initListView(){
	cocos2d::ListViewEx* pListView = WidgetFun::getListViewWidget(this,"GameListView_SRLF");
	...
	pListView->addEventListener((cocos2d::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeRoomListPanel_SRLF::onSelectedItemEvent,this));
...
void GPHomeRoomListPanel_SRLF::RefreshListView(void* data, size_t dataSize){
    ...
    cocos2d::ListViewEx* pList = WidgetFun::getListViewWidget(this,"GameListView_SRLF");
