...
{
	cocos2d::ListViewEx* pListView = WidgetFun::getListViewWidget(this, "GameListView_XZDD");
	...
	pListView->addEventListener((cocos2d::ListViewEx::ccListViewCallback)CC_CALLBACK_2(GPHomeRoomListPanel_XZDD::onSelectedItemEvent, this));
...
void GPHomeRoomListPanel_XZDD::RefreshListView(void* data, size_t dataSize){
	...
	cocos2d::ListViewEx* pList = WidgetFun::getListViewWidget(this, "GameListView_XZDD");
