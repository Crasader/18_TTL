...
#include "../CreateRoomPanel/GPHomeCreateRoomPanel_NN.h"
#include "../CreateRoomPanel/GPHomeCreateRoomPanel_SRLF.h"
#include "../CreateRoomPanel/GPHomeCreateRoomPanel_TLJ.h"
#include "../CreateRoomPanel/GPHomeCreateRoomPanel_SG.h"
#include "../CreateRoomPanel/GPHomeCreateRoomPanel_XZDD.h"
...
void GPHomeEditNumPanel::show(std::string kGameType,int cbIndex)
{
	...
	if(kGameType == "WZQ")
		WidgetFun::setImagic(this,"Edit_Title","GamePlaza/HomeScene/EnterRoomPanel/title_2.png");
	else
		WidgetFun::setImagic(this,"Edit_Title","GamePlaza/HomeScene/EnterRoomPanel/title_3.png");
	m_cbIndex = cbIndex;
	updateRoomNum();
}
