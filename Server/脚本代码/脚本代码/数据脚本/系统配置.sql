...
INSERT [SystemStatusInfo] ([StatusName],[StatusValue],[StatusString],[StatusTip],[StatusDescription]) VALUES ( N'GrantScoreCount',10000000,N'新用户注册系统送金币的数目！',N'注册赠送',N'键值：表示赠送的金币数量')
INSERT [SystemStatusInfo] ([StatusName],[StatusValue],[StatusString],[StatusTip],[StatusDescription]) VALUES ( N'GrantScoreInsure',50,N'新用户注册系统送元宝的数目！',N'注册赠送',N'键值：表示赠送的元宝数量')
...
INSERT [SystemStatusInfo] ([StatusName], [StatusValue], [StatusString], [StatusTip], [StatusDescription]) VALUES (N'RouletteVaildDay', 1, N'轮盘星期', N'轮盘星期', N'轮盘星期')
