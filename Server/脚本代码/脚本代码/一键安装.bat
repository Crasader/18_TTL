...
osql -E -i "%rootPath%比赛链接.sql"
osql -E -i "%rootPath%系统配置.sql"
osql -E -i "%rootPath%用户链接.sql"
osql -E -i "%rootPath%签到配置.sql"
osql -E -i "%rootPath%新手活动配置.sql"
osql -E -i "%rootPath%排名配置 .sql"
osql -E -i "%rootPath%轮盘配置.sql"
