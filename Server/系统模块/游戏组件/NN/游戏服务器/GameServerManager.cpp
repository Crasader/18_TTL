...
CGameServiceManager::CGameServiceManager()
{
	...
	m_GameServiceAttrib.wChairCount=NN_GAME_PLAYER;
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("TTLNN.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("TTLNNServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
VOID * CGameServiceManager::CreateAndroidUserItemSink(REFGUID Guid, DWORD dwQueryVer)
{
	try
	{
		...
		{
			m_AndroidServiceHelper.SetModuleCreateInfo(TEXT("NNAndroid.dll"),TEXT("CreateGameServiceManager"));
