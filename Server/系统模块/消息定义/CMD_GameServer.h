...
#define SUB_GR_PAYMENT_REFRESH_TABLE                          412 //私人场支付服务器通知刷新桌子
#define SUB_GR_PAYMENT_WEIXIN_ORDER_RET                   413 //私人场支付服务器通知刷新桌子
...
//支付指令
#define MDM_GF_PAY			11	

#define SUB_GF_PAY_GEN_ORDER                         100        //请求订单
#define SUB_GF_PAY_GEN_ORDER_RET                  101        //请求订单结果
#define SUB_GF_PAY_GEN_WEIXIN_ORDER            102        //请求微信后台订单
#define SUB_GF_PAY_GEN_WEIXIN_ORDER_RET     103        //请求微信后台订单结果
#define SUB_GF_PAY_SUCCESS                                104        //支付成功

#define IP_LEN                     20
#define ATTACH_LEN          128
struct CMD_GF_Pay_GenWXOrder
{
    WORD wProductID;//商品ID
    char cstrIP[IP_LEN];
    WORD wAttachLen;
    char cstrAttach[ATTACH_LEN];
};

#define NONCE_LEN           64
#define PREPARE_LEN         64
#define ORDER_LEN            64
struct CMD_GF_Pay_GenWXOrder_ret
{
    WORD wPoductID;
    WORD nonce_str_len;
    WORD prepare_id_len;
