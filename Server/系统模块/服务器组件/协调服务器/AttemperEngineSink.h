...
#define SYSTEM_MESSAGE_DETECT_TIME 30000

//timerID

//检测系统消息文本
#define IDI_LOAD_SYSTEM_MESSAGE 1
//发送系统消息文本
#define IDI_SEND_SYSTEM_MESSAGE 2
...
public:
    ...
    //辅助函数
    bool SendSystemMessage(TCHAR *szInfo);
