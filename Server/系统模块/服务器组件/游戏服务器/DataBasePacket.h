...
struct DBR_GP_Private_Refresh_Table
{
	DWORD dwUserSocketID;//玩家ID
    DWORD dwUserID;//玩家ID
    DWORD dwTableID;//玩家桌子ID
};

struct DBR_GP_Private_Refresh_Table_Ret
{
	DWORD dwUserSocketID;//玩家ID
    DWORD dwUserID;//玩家ID
    DWORD dwUserScore;//玩家金钱
	DWORD dwInsureScore;//房卡
    DWORD dwTableID;//玩家桌子ID
};
