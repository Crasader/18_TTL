...
protected:
	...
	bool OnRequestPrivateRebate(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
#endif
	bool OnRequestRefreshTable(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
