...
VOID CInitParameter::InitParameter()
{
    ...
    //支付服务器信息
    m_wPaymentPort = 0;
    ZeroMemory(&m_PaymentAddress, sizeof(m_PaymentAddress));
...
VOID CInitParameter::LoadInitParameter()
{
    ...
    //支付服务器信息
    m_wPaymentPort = (WORD)IniData.ReadInt(TEXT("PaymentServer"),TEXT("ServerPort"), 8080);
    IniData.ReadEncryptString(TEXT("PaymentServer"),TEXT("ServerAddr"),NULL,m_PaymentAddress.szAddress,CountArray(m_PaymentAddress.szAddress));
    IniData.ReadString(TEXT("PaymentServer"),TEXT("platform_id"), NULL, m_PaymentID.szAddress, CountArray(m_PaymentID.szAddress));
