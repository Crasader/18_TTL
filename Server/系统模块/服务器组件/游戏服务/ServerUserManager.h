...
public:
    ...
    //设定用户积分
    virtual void SetUserScore(SCORE score) override { m_UserInfo.lScore = score; }
	//设定用户房卡
	virtual void SetUserInsureScore(SCORE InsureScore) override { m_UserInfo.lInsure = InsureScore; }
	//用户成绩
