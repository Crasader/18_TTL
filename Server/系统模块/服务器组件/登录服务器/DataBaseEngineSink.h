...
protected:
	//获取推荐人列表
	bool OnRequestPopularizeList(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//绑定邀请码
	bool OnRequestPopularizeBind(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//推广Http
	bool OnRequestPopularizeHttp(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//游戏记录
protected:
	//游戏记录
	...
	//游戏记录
	bool OnRequestGameRecordListEx(DWORD dwContextID, VOID * pData, WORD wDataSize);
