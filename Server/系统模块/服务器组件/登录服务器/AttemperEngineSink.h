...
protected:
	...
	//推广人相关
	//获取推广人列表
	bool OnDBPopularizeList(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//绑定邀请码
	bool OnDBPopularizeBind(DWORD dwContextID, VOID * pData, WORD wDataSize);

	bool OnDBPopularizeHttp(DWORD dwContextID, VOID * pData, WORD wDataSize);

	//游戏记录
	bool OnDBPCGameRecordList(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//游戏记录
	bool OnDBPCGameRecordListEx(DWORD dwContextID, VOID * pData, WORD wDataSize);
	//游戏记录
