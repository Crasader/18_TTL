...
#define DBO_GP_GAME_RECORD_LIST_EX		253									//记录列表							
...
//推广人相关
#define DBO_GP_POPULARIZE_LIST 280 //推广人列表
#define DBO_GP_POPULARIZE_BIND 281 //绑定邀请码
#define DBO_GP_POPULARIZE_HTTP 282 //推广图片HTTP
