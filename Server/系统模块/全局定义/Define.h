...
#define IMAGE_CX					92									//3D形象宽度
#define IMAGE_CY					155									//3D形象高度
...
#define INVALID_USERID				0xFFFF								//无效桌子
...
#define GAME_STATUS_MASTER_END 300							//房间结束
...
#define LEN_UNDER_WRITE				32									//社团名字

//数据长度
#define LEN_POPULARIZE_CODE         8                     //邀请码长度
...
#define LEN_SIGIN					5									//签到长度
#define LEN_ROULETTE				12									//轮盘长度
#define LEN_BEGINNER				32									//新手活动长度
#define LEN_ADDRANK					50									//赚金榜
#define LEN_MSG_FILE				64									//消息文本名字长度
...
//用户状态
#define US_ERROR                    0xffffffff                          //错误状态
